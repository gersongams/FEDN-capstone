...
let tripData = [
  {
    "countryName": "Peru",
    "cityName": "Lima",
    "departing": "2020-07-14",
    "image": "https://pixabay.com/get/53e0d7434e53b108f5d084609629307f163ddae3514c704c7c2c72d6904bcc5f_1280.jpg",
    "highTemperature": 20.6,
    "lowerTemperature": 15.2,
    "weather": "Few clouds",
    "daysRemaining": 9,
    "id": "05bd4b27-f382-450a-aba7-4f607c2093b2"
  },
  {
    "countryName": "France",
    "cityName": "Paris",
    "departing": "2020-07-29",
    "image": "https://pixabay.com/get/5ee4d641485bb108f5d084609629307f163ddae3514c704c7c2c72d69e4cc15e_1280.jpg",
...
const dateTransform = (startDate, endDate, diffDays) => {
  ...
  return diffDays < 16 ? [startDate, endDate] : [startSplitted.join('-'), endSplitted.join('-')]
}
...
app.get('/trips', (req, res) => {
  const sortedTrips = tripData.slice()
